...
按P0-05A阶段顺序先完成离线证据合同、隔离harness、receipt来源绑定和V1-9入口就绪审计，并让无授权preflight以零Provider请求失败。真实Provider连续3组等待用户另行批准channel、model fingerprint、总费用和最大调用次数；P0-05A Go后才允许进入P0-05B并创建新的V1-9 plan、manifest和runId。

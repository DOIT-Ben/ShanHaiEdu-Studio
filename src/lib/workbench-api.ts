...
export function createWorkbenchApiClient(options: WorkbenchApiClientOptions = {}): WorkbenchDataSource {
  ...
  return {
    listProjects() {
      return request<ProjectItem[]>("/api/workbench/projects");
    },
    createProject() {
      return request<WorkbenchSnapshot>("/api/workbench/projects", { method: "POST" });
    },
    getProjectSnapshot(projectId) {
      return request<WorkbenchSnapshot>(`/api/workbench/projects/${projectId}/snapshot`);
    },
    sendMessage(projectId, body, reference) {
      return request<WorkbenchSnapshot>(`/api/workbench/projects/${projectId}/messages`, {
        method: "POST",
        body: JSON.stringify({ body, reference }),
      });
    },
    approveArtifact(projectId, artifactKey) {
      return request<WorkbenchSnapshot>(`/api/workbench/projects/${projectId}/artifacts/${artifactKey}/approve`, { method: "POST" });
    },
    regenerateArtifact(projectId, artifactKey) {
      return request<WorkbenchSnapshot>(`/api/workbench/projects/${projectId}/artifacts/${artifactKey}/regenerate`, { method: "POST" });
    },
  };
}

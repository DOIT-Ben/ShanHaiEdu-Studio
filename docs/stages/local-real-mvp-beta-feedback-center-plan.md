# Local Real MVP 内测反馈中心阶段规划

日期：2026-07-10

状态：上线前阶段规划；尚未实现。

测试定义：`docs\stages\local-real-mvp-beta-feedback-center-test-plan.md`。
...
`attachmentRefs` 只保存受控对象引用，不保存 base64 和公开路径。
...
```text
docs\stages\local-real-mvp-beta-feedback-center-test-plan.md
```

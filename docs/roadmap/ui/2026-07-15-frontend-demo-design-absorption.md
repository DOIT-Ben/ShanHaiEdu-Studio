...
- `docs\roadmap\product\v1-agent-guided-response-presentation-requirements.md`
- `docs\roadmap\product\v1-5-artifact-workspace-requirements.md`
- `docs\roadmap\architecture\2026-07-13-adr-当前成果工作区替代常驻糖葫芦.md`
...
本文件只冻结吸收方向，不授权打断当前V1.0智能体原子Tool重构。除本次重构已明确要求的真实步骤投影外，其余Demo吸收只在未来正式前端阶段按以下顺序实施：

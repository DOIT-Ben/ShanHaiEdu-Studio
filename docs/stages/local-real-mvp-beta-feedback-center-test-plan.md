...
```powershell
npx vitest run tests/feedback-contract.test.ts tests/feedback-storage.test.ts tests/feedback-service.test.ts tests/feedback-auth.test.ts --maxWorkers=1
npm run build
